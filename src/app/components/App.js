...
import { HamburgerMenuIcon, Cross2Icon, MoonIcon, SunIcon, ChevronDownIcon } from '@radix-ui/react-icons';
import { FaInstagram, FaLinkedin, FaYoutube, FaTwitter } from 'react-icons/fa';
import ImageCarousel from './ImageCarousel';

// Lista de imágenes válidas
const validImages = [
  '2+Fatima53-1920w.jpg',
  'A+la+de+tres-11-1920w.jpg',
  'Belén-27-1920w.jpg',
  'Captura+de+pantalla+2024-04-18+a+las+18.14.45-1920w.png',
  'Concierto_Pasión-193-1920w.jpg',
  'Diario+fotos44-1920w.jpg',
  'HGM+24-112-1920w.jpg',
  'HKN+invi-3-1920w.jpg',
  'IMG_2680-1920w.JPG',
  'Nisse+10-fde4f6f2-1920w.jpg',
  'ROCIOyALBERTO-126-1920w.jpg',
];
...
const LogoItem = () => (
  <div className="h-16 flex items-center justify-center p-2">
    <img 
      src="/images/logo+ALMURES+web-03-340w.png" 
      alt="ALMURES Logo" 
...
const App = () => {
  ...
  const closeModal = () => {
    ...
    document.body.style.overflow = 'unset'; // Restaura el scroll al cerrar el modal
  };
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
            ...
            <div className="flex items-center">
              ...
              >
                {mounted && theme === 'dark' ? (
                  ...
                  <MoonIcon width={20} height={20} className="text-gray-700" />
                )}
              </button>
              ...
              >
                {mobileMenuOpen ? (
                  <Cross2Icon width={24} height={24} className="text-gray-700 dark:text-gray-300" />
                ) : (
                  <HamburgerMenuIcon width={24} height={24} className="text-gray-700 dark:text-gray-300" />
                )}
              </button>
            </div>
          </div>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-gradient-to-b from-gray-900 to-gray-800 text-white">
        <div className="absolute inset-0 opacity-20 bg-center bg-cover bg-no-repeat" style={{ backgroundImage: "url('/images/HKN+invi-3-1920w.jpg')" }}></div>
          ...
          <div className="max-w-3xl mx-auto">
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                <button
                  type="submit"
                  className="w-full md:w-auto px-6 py-3 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded-full transition-colors duration-300 flex items-center justify-center"
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="flex justify-center space-x-4 mb-8">
            <SocialIcon icon={<FaInstagram size={20} />} href="https://www.instagram.com/almures_global/" />
            <SocialIcon icon={<FaLinkedin size={20} />} href="https://www.linkedin.com/company/69726084/admin/dashboard/" />
            <SocialIcon icon={<FaYoutube size={20} />} href="https://www.youtube.com/channel/UCh-12jMfcgzdFPe3lGoqhag" />
